...
//获得星期几 chinesePrefix传入”星期“、”周“、"礼拜"以得到不同的字串
- (NSString *)getWeekDayShowStringWithChinesePrefix:(NSString *)chinesePrefix {
    NSString *suffix = @"";
    switch (self.weekday) {
        case 1:
            suffix = IMPLocalizedString(@"WeekDay_Sunday_Suffix");
            break;
        case 2:
            suffix = IMPLocalizedString(@"WeekDay_Monday_Suffix");
            break;
        case 3:
            suffix = IMPLocalizedString(@"WeekDay_Tuesday_Suffix");
            break;
        case 4:
            suffix = IMPLocalizedString(@"WeekDay_Wednesday_Suffix");
            break;
        case 5:
            suffix = IMPLocalizedString(@"WeekDay_Thursday_Suffix");
            break;
        case 6:
            suffix = IMPLocalizedString(@"WeekDay_Friday_Suffix");
            break;
        case 7:
            suffix = IMPLocalizedString(@"WeekDay_Saturday_Suffix");
            break;
        default:
            break;
    }
    return [NSString stringWithFormat:@"%@%@",chinesePrefix,suffix];
}
@end
